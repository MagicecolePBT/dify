const translation = {
  ...
  licenseExpiredTip: 'The license for your workspace has expired. Please contact your administrator to continue using PBT.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect license server. Please contact your administrator to continue using PBT.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The license for your workspace is inactive. Please contact your administrator to continue using PBT.',
}
