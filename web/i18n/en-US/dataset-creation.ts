const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Currently, PBT\'s knowledge base only has limited data sources. Contributing a data source to the PBT knowledge base is a fantastic way to help enhance the platform\'s flexibility and power for all users. Our contribution guide makes it easy to get started. Please click on the link below to learn more.',
