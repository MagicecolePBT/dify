const translation = {
  ...
  stepOne: {
    ...
    connect: '연결하기',
    button: '다음',
    emptyDatasetCreation: '비어있는 RAG 생성',
    modal: {
      title: '비어있는 RAG 생성',
      tip: '비어있는 RAG에는 문서가 포함되지 않으며 언제든지 문서를 업로드할 수 있습니다.',
      input: 'RAG 이름',
      placeholder: '입력하세요',
  ...
  stepTwo: {
    ...
    sideTipP3: '클리닝은 불필요한 문자 및 형식을 제거하여 RAG를 더 깔끔하고 분석 가능한 것으로 만듭니다.',
  ...
  stepThree: {
    creationTitle: '🎉 RAG가 생성되었습니다',
    creationContent: 'RAG 이름이 자동으로 설정되었지만 언제든지 변경할 수 있습니다',
    label: 'RAG 이름',
    additionTitle: '🎉 문서가 업로드되었습니다',
    additionP1: '문서가 RAG에 업로드되었습니다',
    additionP2: 'RAG의 문서 목록에서 찾을 수 있습니다.',
    stop: '처리 중지',
    resume: '처리 재개',
    navTo: '문서로 이동',
    sideTipTitle: '다음 단계는 무엇인가요',
    sideTipContent:
      '문서 인덱싱이 완료되면 RAG를 응용 프로그램 컨텍스트로 통합할 수 있습니다. 프롬프트 오케스트레이션 페이지에서 컨텍스트 설정을 찾을 수 있습니다. 또한 독립된 ChatGPT 인덱스 플러그인으로 출시할 수도 있습니다.',
  ...
  otherDataSource: {
    ...
    description: '현재 PBT의 기술 자료에는 제한된 데이터 소스만 있습니다. PBT 기술 자료에 데이터 소스를 제공하는 것은 모든 사용자를 위해 플랫폼의 유연성과 기능을 향상시키는 데 도움이 되는 환상적인 방법입니다. 기여 가이드를 통해 쉽게 시작할 수 있습니다. 자세한 내용은 아래 링크를 클릭하십시오.', // PBT TODO: change to PBT
  },
}
